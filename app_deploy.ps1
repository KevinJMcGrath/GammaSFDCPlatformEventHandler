...
docker build . -t kevinmcgrath/gamma-tenant-manager:0.1.7

docker tag kevinmcgrath/gamma-tenant-manager:0.1.7 kevinmcgrath/gamma-tenant-manager:latest

docker push kevinmcgrath/gamma-tenant-manager:latest
docker push kevinmcgrath/gamma-tenant-manager:0.1.7
