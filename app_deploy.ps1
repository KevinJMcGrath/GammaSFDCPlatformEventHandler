...
docker build . -t kevinmcgrath/gamma-tenant-manager:0.1.9

docker tag kevinmcgrath/gamma-tenant-manager:0.1.9 kevinmcgrath/gamma-tenant-manager:latest

docker push kevinmcgrath/gamma-tenant-manager:latest
docker push kevinmcgrath/gamma-tenant-manager:0.1.9
